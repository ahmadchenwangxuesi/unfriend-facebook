...
echo console :: blue("[====================================================]\n");
echo console :: green("[         ~FACEBOOK UNFRIEND V.0.1~                 ]\n");
echo console :: cyan("[ Author  : PACE USA                                 ]\n");
echo console :: red("[ Team    : THCA INDONESIAN                           ]\n");
echo console :: yellow("[ Github  : https://github.com/ahmadchenwangxuesi  ]\n");
echo console :: light_purple("[ Youtube : https://youtube.com/             ]\n");
echo console :: blue("[====================================================]\n\n");
